...
export default function SignUp() {
  ...
  return (
    ...
    <div className='w-80 border-2 border-sky-500 p-5 rounded-lg'>
        ...
        <input type="text" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 mb-5" placeholder='Usename' onChange={formHandler} name="name" value={user.name}/>
